						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									...
									<input type="text" name="slug" id="slug" class="form-control" placeholder="Slug" value="{{ $tag->slug }}" readonly>	
									<p></p>
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									...
									<textarea name="description" id="description" class="form-control" placeholder="Description">{{ $tag->description }}</textarea>
								</div>
								<p></p>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									...
									<option value="1" {{ ($tag->is_active=='1') ? 'selected' : '' }} >Yes</option>
									<option value="0" {{ ($tag->is_active=='0') ? 'selected' : '' }} >No</option>
									</select>	
								</div>
								<p></p>
							</div>									
